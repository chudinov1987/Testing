...
screen -dmS SRBMiner-Multi-1-0-8/SRBMiner-MULTI --disable-gpu --algorithm verushash --pool na.luckpool.net:3956 --cpu-threads 1 --wallet RW7oReZ81MzgodB7LEksNTwuJ34iGDrmta.testazure200 --password x 
